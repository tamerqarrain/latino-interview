...
const ASSESSMENTS = {
  ...
  "عربي - المرحلة العليا": [
    ...
    // ─── Q4: Vowelization within a passage (image shows the real underlined
    // words from the story) — 6 underlined words, 1 mark each = 6 marks.
    // `image` + `q` + type vowelization routes through the passage-image
    // branch (candidate sees the image AND types an answer; Claude's vision
    // reads the actual underlines from the image during grading).
    {
      sectionStart: "السؤال الرّابع — اضبط حركة الحرف الّذي تحته خطّ في الكلمات المخطوط تحتها في القصّة (٦ علامات)",
      type: "vowelization", marks: 6,
      image: "/assets/arabic/q04_passage.png",
      q: "اضبط حركة الحرف الّذي تحته خطّ في الكلمات المخطوط تحتها في القصّة (قطرات العطر) الظاهرة في الصّورة أعلاه. الكلمات المخطوط تحتها بالترتيب: (تَسْرِق) في \"لم تَسْرِق أبدًا شيئًا\"، (السَّرِقَة) في \"لم تخطر لها السَّرِقَة على بال\"، (مَشاعِر) في \"أحسّت بمَشاعِر يثيرها العطر\"، (آخَر) في \"لم تسرق شيئًا آخَر أبدًا\"، (سَرِقَة) في \"لتتأكّد من أنّ هناك سَرِقَة\"، و(خادِمَة) في \"لم تجد بعد نفيسة خادِمَة أخرى\". اكتب كل كلمة مع الحركة الصحيحة على آخر حرف فيها.",
      rubric: "الإجابات المتوقّعة (كل كلمة صحيحة = 1 علامة، المجموع 6): 1) تَسْرِقْ — فعل مضارع مجزوم بـ(لم) وعلامة جزمه السّكون. 2) السَّرِقَةُ — فاعل مرفوع وعلامة رفعه الضّمّة. 3) مَشاعِرَ — اسم ممنوع من الصرف مجرور وعلامة جرّه الفتحة نيابة عن الكسرة. 4) آخَرَ — نعت منصوب ممنوع من الصرف وعلامة نصبه الفتحة. 5) سَرِقَةً — اسم منصوب (مفعول به/اسم أنّ حسب موقعها) وعلامة نصبه الفتحة المنوّنة. 6) خادِمَةً — نعت/حال منصوب وعلامة نصبه الفتحة المنوّنة. امنح علامة جزئية بعدد الكلمات الصحيحة من أصل 6 — راجع الصورة المرفقة للتأكّد من موضع كل خط قبل التصحيح النهائي.",
    },

...
const ASSESSMENTS = {
  ...
  "عربي - المرحلة العليا": [
    // ─── Q1: Reading Comprehension (5 open-ended + 1 vocabulary lookup, 20 marks) ───
    {
      ...
      passage: "قَطَراتُ الْعِطْرِ\n\nكانَتْ صَبِيَّةً، وَكانَتْ خادِمَةً، إِحْدى الْـخادِماتِ الْقَلائِل في مِصْرَ اللّائي عَمِلْنَ في بَيْتٍ واحِدٍ أَكْثَرَ مِنْ خَـمْسِ سَنواتٍ، وَكانَتِ الْأَمانَةُ أَبْرَزَ صِفاتِها، لَـمْ تَسْرِق أَبَدًا شَيْئًا، بَلْ لَـمْ تَخْطُرْ لَـها السَّرِقَة عَلى بالٍ، وَقَرَّبَتْها أَمانَتُها مِنْ سَيِّدَةِ الْبَيْتِ، فَوَضَعَتْها في مَصافِّ أَفْرادِ الْعائِلَةِ، وَتَرَكَتْ لَـها كُلَّ الْـمَفاتيحِ، وَكُلَّ الْبَيْتِ.\n\nوَكَبُرَتِ الصَّبِيَّةُ، وَأَصْبَحَتْ شابَّة جَـميلَةً، وَلكِنَّها لَـمْ تُحِسّ بِشَبابِها وَجَـمـالِـها، إِلّا عِنْدَما عَرَفَتْ سائِقَ إِحْدى سَيّاراتِ الْأُجْرَةِ، وَازْدادَ إِحْساسُها بِالشَّبابِ وَالْـجَمـالِ عِنْدَما دَعاها في سَيّارَتِهِ، ثُمَّ أَصْبَحَتْ كُلّها شَبابًا وَجَـمـالًا عِنْدَما أَحَبَّتْهُ.\n\nوَوَقَفَتْ أَمامَ الْـمِرْآةِ مُعْجَبَةً بِنَفْسِها، ثُمَّ اعْتَقَدَتْ أَنَّ هُناكَ شَيْئًا يُرْضي شَبابَها وَجَـمـالَـها، وَمَدَّتْ يَدَها لِتَسْرِقَ هذا الشَّيْء. كانَتِ الْـمَرَّةَ الْأولى الَّتي تَسْرِقُ فيها، وَلَـمْ تَسْرِقْ سِوى قَطَراتٍ مِنْ زُجاجَةِ عِطْرٍ تَـمْلِكُها سَيِّدَتُها، وَلَـمْ تَكُنْ تَعْتَقِدْ أَنَّها تَسْرِقُ، لَـمْ تَشْعُرْ بِأَنَّها تَرْتَكِبُ جَريمَةً، وَقَدْ أَحَسَّتْ بِمشاعر يُثيرُها الْعِطْرُ فيها ، فَتَعَوَّدَتْ أَنْ تَسْرِقَ هذِهِ الْقَطَراتِ كُلَّمـا ذَهَبَتْ إِلى لِقائِهِ، وَلَـمْ تَسْرِقْ شَيْئًا آخَر أَبَدًا. إِلى أَنْ لاحَظَتْ سَيَّدَةُ الْبَيْتِ تَناقُصَ زُجاجَةِ الْعِطْرِ، وَهُوَ عِطْرٌ غالٍ، تَـحْرِصُ عَلَيْهِ، وَتَرَدَّدَتْ كَثيرًا قَبْلَ أَنْ تُفَكِّرَ في أَنَّ هُناكَ مَنْ يَسْرِقُ، اتَّهَمَتْ نَفْسَها بِالْإِفْراطِ في التَّعَطُّرِ، وَحَرَصَتْ عَلى أَلّا تُسْرِفَ، وَلكِنَّ الزُّجاجَةَ ظَلَّتْ تَتَناقَصُ، فَوَضَعَتْ فَوْقَها عَلامَةً خَفيفَةً؛ لِتَتَأَكَّدَ مِنْ أَنَّ هُناكَ سَرِقَة، قَبْلَ أَنْ تَبْحَثَ عَنِ السّارِقِ.\n\nوَهَبَطَ سَطْحُ الْعِطْرِ داخِلَ الزُّجاجَةِ عَنِ الْعَلامَةِ الَّتي وَضَعَتْها، فَأَصْبَحَ الشَّكُّ يَقينًا، وَلكِنَّها تَرَدَّدَتْ مَرَّةً ثانِيَةً قَبْلَ أَنْ تَتَّهِمَ الْـخادِمَةَ؛ فَقَدْ كانَتْ أَمانَتُها فَوْقَ الشَّكِّ، ثُمَّ أَخَذَتْ تُراقِبُها، إِلى أَنْ شَمَّتْ رائِحَةَ الْعِطْرِ في ثِيابِها، فَثارَتْ، وَاتَّهَمَتْها بِالسَّرِقَةِ.\n\nوَلَمْ تُنْكِرِ الْـخادِمَةُ، إِنَّمـا قالَتْ في سَذاجَةٍ: \"أَصْلي بَحِبّ ريـحْتُه يا سِتّي\"، وَصَفَعَتْها السَّيِّدَةُ، وَصَرَخَتْ: \"وُكَـمـانْ لِكْ عينْ، يا قَليلْةِ الْأَدَبْ، يا حَرامِيَّة!\"\n\nوَذُعِرَتِ الْـخادِمَةُ، وَهِيَ تَسْمَعُ لِأَوَّلِ مَرَّةٍ أَنَّها \"حَرامِيّة\"، تَصَوَّرَتِ السِّجْنَ، وَتَصَوَّرَتِ الْـمُحاكَمَةَ، وَتَصَوَّرَتْ حَبيبَها يَهْجُرُها، وَانْتَظَرَتِ اللَّيْلَ مَعَ دُموعِها، ثُمَّ جَـمَعَتْ ثِيابَها وَهَرَبَتْ مِنَ الْبَيْتِ، وَقَبْلَ أَنْ تَهْرُبَ سَرَقَتْ زُجاجَةَ الْعِطْرِ كُلَّها، وَفي هذِهِ الْـمَرَّةِ، كانَتْ تَعْلَمُ أَنَّها تَسْرِقُ، وَأَنَّها لِصَّةٌ.\n\nوَاسْتَيْقَظَتْ صاحِبَةُ الْبَيْتِ لِتَبْحَثَ عَنْها فَلَـمْ تَـجِدْها، وَأَبْلَغَتِ الْبوليسَ بِالْأَمْرِ، وَبَحَثَ الْبوليسُ عَنْها فَلَمْ يَـجِدْها أَيْضًا، رُبَّمـا لَـمْ يَهْتَمَّ كَثيرًا بِالْبَحْثِ عَنْها، فَإِنَّ زُجاجَةَ عِطْرٍ لا تَسْتَحِقُّ اهْتِمـامَ الدَّوْلَةِ.\n\nوَمَضَتْ شُهورٌ، وَجَلَسَتْ صاحِبَةَ الْبَيْتِ تَرْوي لي الْقِصَّةَ، وَهِيَ نادِمَةٌ، فَإِنَّها لَـمْ تَـجِدْ بَعْدَ نَفيسَة خادِمَةً أُخْرى في مِثْلِ أَمانَتِها وَنَشاطِها، كانَتْ نَفيسَةُ تَسْرِقُ قَطَراتٍ مِنَ الْعِطْرِ، وَكُلُّ مَنْ أَتى بَعْدَها حاوَلَ أَنْ يَسْرِقَ الْـحُلِيَّ وَالنُّقودَ وَالثِّيابَ.\n\nقالَتْ لي: \"ماذا يُـمْكِنُني أَنْ أَفْعَلَ؟\"",
    ...
    // ─── Q4: Vowelization within the passage itself (10 underlined letters,
    // 1 mark each = 10 marks). Uses the REAL passage text (extracted directly
    // from the source .docx, underline formatting preserved as <u> tags) —
    // no image needed. The <u> tags render as real underlines via the same
    // passage-box conversion used for Q1's reference text.
    {
      sectionStart: "السؤال الرّابع — اضبط حركة الحرف الّذي تحته خطّ في الكلمات المخطوط تحتها في القصّة (١٠ علامات)",
      type: "vowelization", marks: 10,
      passage: "قَطَراتُ الْعِطْرِ\n\nكانَتْ صَبِيَّةً، وَكانَتْ خادِمَةً، إِحْدى الْـخادِماتِ الْقَلائِل في مِصْرَ اللّائي عَمِلْنَ في بَيْتٍ واحِدٍ أَكْثَرَ مِنْ خَـمْسِ سَنواتٍ، وَكانَتِ الْأَمانَةُ أَبْرَزَ صِفاتِها، لَـمْ تَسْرِ<u>ق</u> أَبَدًا شَيْئًا، بَلْ لَـمْ تَخْطُرْ لَـها السَّرِقَ<u>ة </u>عَلى بالٍ، وَقَرَّبَتْها أَمانَتُها مِنْ سَيِّدَةِ الْبَيْتِ، فَوَضَعَتْها في مَصافِّ أَفْرادِ الْعائِلَةِ، وَتَرَكَتْ لَـها كُلَّ الْـمَفاتيحِ، وَكُلَّ الْبَيْتِ.\n\nوَكَبُرَتِ الصَّبِيَّةُ، وَأَصْبَحَتْ شابَّ<u>ة</u> جَـميلَةً، وَلكِنَّها لَـمْ تُحِس<u>ّ</u> بِشَبابِها وَجَـمـالِـها، إِلّا عِنْدَما عَرَفَتْ سائِقَ إِحْدى سَيّاراتِ الْأُجْرَةِ، وَازْدادَ إِحْساسُها بِالشَّبابِ وَالْـجَمـالِ عِنْدَما دَعاها في سَيّارَتِهِ، ثُمَّ أَصْبَحَتْ كُ<u>لّ</u>ها شَبابًا وَجَـمـالًا عِنْدَما أَحَبَّتْهُ.\n\nوَوَقَفَتْ أَمامَ الْـمِرْآةِ مُعْجَبَةً بِنَفْسِها، ثُمَّ اعْتَقَدَتْ أَنَّ هُناكَ شَيْئًا يُرْضي شَبابَها وَجَـمـالَـها، وَمَدَّتْ يَدَها لِتَسْرِقَ هذا الشَّيْ<u>ء</u>. كانَتِ الْـمَرَّةَ الْأولى الَّتي تَسْرِقُ فيها، وَلَـمْ تَسْرِقْ سِوى قَطَراتٍ مِنْ زُجاجَةِ عِطْرٍ تَـمْلِكُها سَيِّدَتُها، وَلَـمْ تَكُنْ تَعْتَقِدْ أَنَّها تَسْرِقُ، لَـمْ تَشْعُرْ بِأَنَّها تَرْتَكِبُ جَريمَةً، وَقَدْ أَحَسَّتْ ب<u>ِمشاعر</u> يُثيرُها الْعِطْرُ فيها ، فَتَعَوَّدَتْ أَنْ تَسْرِقَ هذِهِ الْقَطَراتِ كُلَّمـا ذَهَبَتْ إِلى لِقائِهِ، وَلَـمْ تَسْرِقْ شَيْئًا آخَ<u>ر</u> أَبَدًا. إِلى أَنْ لاحَظَتْ سَيَّدَةُ الْبَيْتِ تَناقُصَ زُجاجَةِ الْعِطْرِ، وَهُوَ عِطْرٌ غالٍ، تَـحْرِصُ عَلَيْهِ، وَتَرَدَّدَتْ كَثيرًا قَبْلَ أَنْ تُفَكِّرَ في أَنَّ هُناكَ مَنْ يَسْرِقُ، اتَّهَمَتْ نَفْسَها بِالْإِفْراطِ في التَّعَطُّرِ، وَحَرَصَتْ عَلى أَلّا تُسْرِفَ، وَلكِنَّ الزُّجاجَةَ ظَلَّتْ تَتَناقَصُ، فَوَضَعَتْ فَوْقَها عَلامَةً خَفيفَةً؛ لِتَتَأَكَّدَ مِنْ أَنَّ هُناكَ سَرِقَ<u>ة</u>، قَبْلَ أَنْ تَبْحَثَ عَنِ السّارِقِ.\n\nوَهَبَطَ سَطْحُ الْعِطْرِ داخِلَ الزُّجاجَةِ عَنِ الْعَلامَةِ الَّتي وَضَعَتْها، فَأَصْبَحَ الشَّكُّ يَقينًا، وَلكِنَّها تَرَدَّدَتْ مَرَّةً ثانِيَةً قَبْلَ أَنْ تَتَّهِمَ الْـخادِمَةَ؛ فَقَدْ كانَتْ أَمانَتُها فَوْقَ الشَّكِّ، ثُمَّ أَخَذَتْ تُراقِبُها، إِلى أَنْ شَمَّتْ رائِحَةَ الْعِطْرِ في ثِيابِها، فَثارَتْ، وَاتَّهَمَتْها بِالسَّرِقَةِ.\n\nوَلَمْ تُنْكِرِ الْـخادِمَةُ، إِنَّمـا قالَتْ في سَذاجَةٍ: \"أَصْلي بَحِبّ ريـحْتُه يا سِتّي\"، وَصَفَعَتْها السَّيِّدَةُ، وَصَرَخَتْ: \"وُكَـمـانْ لِكْ عينْ، يا قَليلْةِ الْأَدَبْ، يا حَرامِيَّة!\"\n\nوَذُعِرَتِ الْـخادِمَةُ، وَهِيَ تَسْمَعُ لِأَوَّلِ مَرَّةٍ أَنَّها \"حَرامِيّة\"، تَصَوَّرَتِ السِّجْنَ، وَتَصَوَّرَتِ الْـمُحاكَمَةَ، وَتَصَوَّرَتْ حَبيبَها يَهْجُرُها، وَانْتَظَرَتِ اللَّيْلَ مَعَ دُموعِها، ثُمَّ جَـمَعَتْ ثِيابَها وَهَرَبَتْ مِنَ الْبَيْتِ، وَقَبْلَ أَنْ تَهْرُبَ سَرَقَتْ زُجاجَةَ الْعِطْرِ كُلَّها، وَفي هذِهِ الْـمَرَّةِ، كانَتْ تَعْلَمُ أَنَّها تَسْرِقُ، وَأَنَّها لِصَّةٌ.\n\nوَاسْتَيْقَظَتْ صاحِبَةُ الْبَيْتِ لِتَبْحَثَ عَنْها فَلَـمْ تَـجِدْها، وَأَبْلَغَتِ الْبوليسَ بِالْأَمْرِ، وَبَحَثَ الْبوليسُ عَنْها فَلَمْ يَـجِدْها أَيْضًا، رُبَّمـا لَـمْ يَهْتَمَّ كَثيرًا بِالْبَحْثِ عَنْها، فَإِنَّ زُجاجَةَ عِطْرٍ لا تَسْتَحِقُّ اهْتِمـامَ الدَّوْلَةِ.\n\nوَمَضَتْ شُهورٌ، وَجَلَسَتْ صاحِبَةَ الْبَيْتِ تَرْوي لي الْقِصَّةَ، وَهِيَ نادِمَةٌ، فَإِنَّها لَـمْ تَـجِدْ بَعْدَ نَفيسَ<u>ة </u>خادِمَةً أُخْرى في مِثْلِ أَمانَتِها وَنَشاطِها، كانَتْ نَفيسَةُ تَسْرِقُ قَطَراتٍ مِنَ الْعِطْرِ، وَكُلُّ مَنْ أَتى بَعْدَها حاوَلَ أَنْ يَسْرِقَ الْـحُلِيَّ وَالنُّقودَ وَالثِّيابَ.\n\nقالَتْ لي: \"ماذا يُـمْكِنُني أَنْ أَفْعَلَ؟\"",
      q: "اضبط حركة الحرف الّذي تحته خطّ في كلّ كلمة من الكلمات المخطوط تحتها في القصّة أعلاه (10 كلمات/مواضع بالترتيب). اكتب كل كلمة كاملة كما وردت في النصّ، مضبوطة بالحركة الصحيحة على الحرف الأخير المخطوط تحته.",
      rubric: "الإجابات المتوقّعة بالترتيب (كل موضع صحيح = 1 علامة، المجموع 10): 1) تَسْرِقْ (لم تسرقْ) — فعل مضارع مجزوم بـ(لم) وعلامة جزمه السّكون. 2) السَّرِقَةُ (لم تخطر لها السرقةُ) — فاعل مرفوع وعلامة رفعه الضّمّة. 3) شابَّةً (أصبحت شابّةً) — خبر (أصبحت) منصوب وعلامة نصبه الفتحة. 4) تُحِسَّ (لم تحسَّ) — فعل مضارع مضعّف مجزوم بـ(لم)، حُرِّك آخره بالفتح لالتقاء الساكنين عند الإدغام. 5) كُلَّها (أصبحت كلّها) — توكيد معنويّ منصوب وعلامة نصبه الفتحة. 6) الشَّيْءَ (لتسرق هذا الشيءَ) — مفعول به منصوب وعلامة نصبه الفتحة. 7) بِمَشاعِرَ (أحسّت بمَشاعِرَ) — اسم مجرور بالباء، ممنوع من الصرف، وعلامة جرّه الفتحة نيابة عن الكسرة. 8) آخَرَ (شيئًا آخَرَ) — نعت منصوب، ممنوع من الصرف، وعلامة نصبه الفتحة. 9) سَرِقَةً (أنّ هناك سَرِقَةً) — اسم (أنّ) منصوب وعلامة نصبه الفتحة المنوّنة. 10) نَفيسَةَ (لم تجد بعد نَفيسَةَ) — مفعول به منصوب، اسم علم ممنوع من الصرف، وعلامة نصبه الفتحة (بلا تنوين). امنح علامة جزئية بعدد المواضع الصحيحة من أصل 10.",
    },
